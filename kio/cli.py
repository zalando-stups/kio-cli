...
def list_apps(config, output, since, team, incident_contact, **kwargs):
    ...
    with OutputFormat(output):
        print_table(['id', 'team_id', 'criticality_level', 'incident_contact', 'name', 'subtitle', 'last_modified_time'],
                    rows, titles={'last_modified_time': 'Modified', 'criticality_level': 'Tier'}, max_column_widths={'name': 32, 'subtitle': 32})
